...
- Keep the package a generic router runtime, not an application shell or demo app.
- Treat path matching, redirect behavior, metadata updates, and active-link state as compatibility-sensitive.
...
Open an issue: https://github.com/koppajs/koppajs-router/issues
